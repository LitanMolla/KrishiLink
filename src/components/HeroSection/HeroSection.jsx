            ...
            <section className='mb-10 hero-slider w-full  overflow-hidden'>
                <Slider {...settings}>
                    <div className="relative">
                        <img className="w-full max-h-[70vh] object-cover" src={vegetables} alt="vegetables" />
                    ...
                    <div className="relative">
                        <img className="w-full max-h-[70vh] object-cover" src={working} alt="working" />
                        <div className="absolute inset-0 bg-black/50 flex justify-center items-center">
                            <div className="container text-center space-y-3">
                    ...
                    <div className="relative">
                        <img className="w-full max-h-[70vh] object-cover" src={handshake} alt="handshake" />
                        <div className="absolute inset-0 bg-black/50 flex justify-center items-center">
                            <div className="container text-center space-y-3">
